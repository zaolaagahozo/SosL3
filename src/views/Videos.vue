  ...
  <section class="bg-white py-20 px-8">
    ...
    <div class="grid md:grid-cols-3 gap-8">
      ...
      <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:scale-105 transition duration-300">
        <video src="/src/assets/EDIT.mp4" controls class="w-full h-64 object-cover">
        </video>
        <div class="p-5">
      ...
      <!-- Card 2 -->
      <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:scale-105 transition duration-300">
        <video src="/src/assets/KIGALIEDIT.mp4" controls class="w-full h-64 object-cover">
        </video>
        <div class="p-5">
          <h2 class="text-2xl font-bold text-green-700">
            visit Rwanda
          ...
          <p class="text-gray-600 mt-2">
            Experience unforgettable of the land of thousand hills
          </p>
        </div>
      </div>
      <!-- Card 3 -->
      <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:scale-105 transition duration-300">
        <video src="/src/assets/rwanda.mp4" controls class="w-full h-64 object-cover">
        </video>
        <div class="p-5">
          <h2 class="text-2xl font-bold text-green-700">
            visit Rwanda
